...
def bitcoin_data(address, scaler, model):
    """
            ...
            for o in event.outputs:
                transaction_pairs.append(tuple([i.address,
                                                o.address,
                                                {
                                                 ...
                                                 'isLegal': predict(event.hash, scaler, model),
                                                 'hash': event.hash,
...
def bitcoin_network(node_data, scaler, model):
    """
    ...
    network_data = []
    for i in node_data:
        network_data.append(bitcoin_data(i[0], scaler, model))
